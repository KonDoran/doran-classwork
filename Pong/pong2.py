...
class Ball(pygame.sprite.Sprite):
    ...
    def __init__(self, color, width, height):
        ...
        self.velocity = [randint(4,14),randint(-10,10)]
...
def button_2(msg2,xb2,yb2,wb2,hb2,icb2,acb2,action2=None):
    ...
    smallText = pygame.font.Font("freesansbold.ttf",30)
    textSurf, textRect = text_objects(msg2, smallText)
            ...
            if event.type == pygame.QUIT: # If user clicked close
              options = False # Flag that we are done so we exit this loop
                    ...
                    if event.key==pygame.K_ESCAPE: 
                         options = False
        screen.fill(BLACK)
        button_2("EASY",510,250,250,60,WHITE,GREY,"E")
        button_2("MEDIUM",510,330,250,60,WHITE,GREY,"M")
        button_2("HARD",510,410,250,60,WHITE,GREY,"H")
        button_2("BACK",510,490,250,60,WHITE,GREY,"B")
        pygame.display.flip()
        clock.tick(60)                 
